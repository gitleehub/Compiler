 ...
 * @author John
 */
public class TreePanelForDFS extends JPanel {
	 ...
	 * @see TreePanelForDFS#CHILD_ALIGN_RELATIVE
	 * @see TreePanelForDFS#CHILD_ALIGN_ABSOLUTE
	 */
	public TreePanelForDFS(int childAlign) {
	 ...
	 * @param childAlign 对齐策略
	 */
	public TreePanelForDFS(Node n, int childAlign) {
		super();
		setTree(n);
